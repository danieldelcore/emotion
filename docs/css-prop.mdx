...
If you find that emotion's default style precedence does not work for your use-case, you can override it with the [Class Names API](https://emotion.sh/docs/class-names). 
